...
<body>
  ...
  <main style="background: #333; margin-top: 130px;">
    <div class="container">
      ...
      <img src="image/drinkcover.jpg" style="width: 100%; margin-bottom: 20px;">
      <div class="col-lg-6">
        <div class="col-lg-12 food">
          <div class="col-lg-7">
            <img src="image/d1.png" style="width: 100%;">
          </div>
          <div class="col-lg-5">
            <h3 style="color: black;">โค้ก/สไปรท์/แฟนต้า</h3>
            <p style="color: black;">จับคู่มื้ออาหารกับเครื่องดื่มซาบซ่า จะเมนูไหนก็ลงตัว</p>
            <div class="clearfix" style="padding-top: 20px;">
              <h3 class="col-lg-6" style="margin: 0px; color: black;">฿ 35</h3>
      ...
      <div class="col-lg-6">
        <div class="col-lg-12 food">
          <div class="col-lg-7">
            <img src="image/d2.png" style="width: 100%;">
          </div>
          <div class="col-lg-5">
            <h3 style="color: black;">ชามะนาวเย็น</h3>
            <p style="color: black;">มาชาร์ตแบตเติมความสดชื่นด้วยชามะนาวเย็นๆ สักแก้ว กับรสชาติหอมหวาน</p>
            <div class="clearfix" style="padding-top: 20px;">
              <h3 class="col-lg-6" style="margin: 0px; color: black;">฿ 35</h3>
              <a class="btn btn-default btn-lg col-lg-6" href="#" role="button">สั้งซื้อ</a>
            </div>
      ...
      <div class="col-lg-6">
        <div class="col-lg-12 food">
          <div class="col-lg-7">
            <img src="image/d3.png" style="width: 100%;">
          </div>
          <div class="col-lg-5">
            <h3 style="color: black;">มะนาวโซดา</h3>
            <p style="color: black;">เติมความสดชื่นด้วยมะนาวโซดา เติมความสดใสให้พร้อมสู้อากาศร้อนได้อีกด้วย</p>
            <div class="clearfix" style="padding-top: 20px;">
              <h3 class="col-lg-6" style="margin: 0px; color: black;">฿ 65</h3>
              <a class="btn btn-default btn-lg col-lg-6" href="#" role="button">สั้งซื้อ</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="col-lg-12 food">
          <div class="col-lg-7">
            <img src="image/d6.png" style="width: 100%;">
          </div>
          <div class="col-lg-5">
            <h3 style="color: black;">เป๊ปซี่ 1.45 LT.</h3>
            <p style="color: black;">เป๊ปซี่ 550 มล.</p>
            <div class="clearfix" style="padding-top: 20px;">
              <h3 class="col-lg-6" style="margin: 0px; color: black;">฿ 45</h3>
              <a class="btn btn-default btn-lg col-lg-6" href="#" role="button">สั้งซื้อ</a>
            </div>
          </div>
        </div>
