    ...
    <main style="background: #333; margin-top: 130px;">
      <div class="container">
        ...
        <div style="position: relative;">
          ...
          <div class="btn-group position">
            ...
            <ul class="dropdown-menu" style="left:-285px;">
              ...
              <button type="button" class="btn btn-primary" style="float:right; margin-top:3px; margin-right:20px; padding: 3px 10px;">อัพเดท</button>
            </ul>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          ...
          <img src="../image/pasta7.png" class="position4">
